...
"[project]/app/brain/index.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$brain$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/brain/index.ts [app-client] (ecmascript)"); // This should work since you have frontend/app/brain/index.ts
;
...
const CommitmentDashboard = ({ commitments, onUpdateProgress, onClaimReward })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    commitment.current_progress >= commitment.target_value && commitment.status !== 'rewarded' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        onClick: ()=>onClaimReward(commitment.id),
                                        className: "bg-yellow-500/20 hover:bg-yellow-500/30 border border-yellow-500/50 text-yellow-400 px-3 py-1 rounded",
                                    ...
                                    commitment.reward_claimed && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
...
function Home() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Home.useEffect": ()=>{
            ...
            }["Home.useEffect.interval"], 30000); // 30 seconds
            return ({
    ...
    const fetchAllData = async ()=>{
        try {
            ...
            // Fetch commitments
            try {
                const commitmentsResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$brain$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get_all_commitments();
                if (commitmentsResponse.ok) {
                    const commitmentsData = await commitmentsResponse.json();
                    setCommitments(commitmentsData.commitments || []);
                }
            ...
            // Replace with this:
            try {
                const envResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$brain$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get_environmental_data();
                if (envResponse.ok) {
                    const envData = await envResponse.json();
                    setEnvironmentalData(envData);
                }
            ...
            // Fetch satellite data
            try {
                const satResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$brain$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get_satellite_data({
                    commitmentId: 1
                });
                if (satResponse.ok) {
                    const satData = await satResponse.json();
    ...
    const handleCreateCommitment = async (e)=>{
        ...
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$brain$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].create_commitment(commitmentData);
            if (response.ok) {
            ...
            const errorMessage = err instanceof Error ? err.message : 'Please try again.';
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(`Error creating commitment: ${errorMessage}`);
            console.error('Error creating commitment:', err);
        }
    };
    const handleUpdateProgress = async (commitmentId, newProgress)=>{
        try {
            ...
            //new_progress: newProgress
            //});
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$brain$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].update_commitment_progress({
                commitment_id: commitmentId
            }, {
            ...
            const errorMessage = err instanceof Error ? err.message : 'Please try again.';
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(`Error updating progress: ${errorMessage}`);
            console.error('Error updating progress:', err);
        }
    };
    const handleClaimReward = async (commitmentId)=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$brain$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].claim_reward({
                commitment_id: commitmentId
            });
            if (response.ok) {
                const result = await response.json();
            ...
            const errorMessage = err instanceof Error ? err.message : 'Please try again.';
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(`Error claiming reward: ${errorMessage}`);
            console.error('Error claiming reward:', err);
        }
    };
    if (loading) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            currentView === 'dashboard' ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(CommitmentDashboard, {
                commitments: commitments,
                onUpdateProgress: handleUpdateProgress,
                onClaimReward: handleClaimReward
            }, void 0, false, {
...
_s(Home, "/Yy92ECuetr9beQkwSpyKA1/4j0=");
_c1 = Home;
var _c, _c1;
...
//# sourceMappingURL=app_f3178926._.js.map