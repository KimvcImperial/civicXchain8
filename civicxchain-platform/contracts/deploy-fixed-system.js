// Fixed deployment script for CivicXChain system
const { ethers } = require("hardhat");

async function main() {
  console.log("🚀 Deploying CivicXChain System (Fixed)...");
  ...
  const fs = require('fs');
  fs.writeFileSync('fixed-system-config.json', JSON.stringify(addresses, null, 2));
