...
async function deployNoTokenContract() {
    try {
        console.log('🚀 Deploying Updated CivicXChain Contract (No Token Requirement)...\n');
        ...
        // Oracle addresses (using existing Sepolia oracles)
        ...
        console.log('   - Removed CIVIC token requirement for claiming rewards');
        console.log('   - Only ETH rewards (150% of stake) are paid out');
...
// Run deployment
deployNoTokenContract().catch(console.error);
